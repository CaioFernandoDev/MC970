...
--------------------------------------------------------------------------------
- Did you set the loop scheduling policy?
- If not specified, which policy is chosen by default?
- Did other loop scheduling options yield different execution times? Why or why not?
